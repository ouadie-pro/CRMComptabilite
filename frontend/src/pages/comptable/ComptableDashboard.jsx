  ...
  const fetchDashboardData = async () => {
    try {
      ...
      setStats({
        ...
        totalClients: Array.isArray(clientsRes) ? clientsRes.length : (clientsRes.data?.length || 0),
        totalProducts: 0,
      });
    ...
    <PageLayout title="Tableau de bord Comptable">
      <div className="space-y-6">
        <div className="flex items-center gap-2 border-b border-slate-200 dark:border-slate-700 pb-4 overflow-x-auto">
          ...
          <TabButton active={activeTab === 'caisse'} onClick={() => { setActiveTab('caisse'); navigate('/comptable/caisse'); }} icon={FiCreditCard} label="Caisse" />
